...
/*
Here We have to perform two operation
1) We have to ignore that edge :- If by ignoring the edge we get the mst > mini_mst than we have to keep that edge in critical array
2) We have to keep that edge :- If by including the edge if we get the mst==mini_mst than we have to keep that edge in pseudo array
*/
